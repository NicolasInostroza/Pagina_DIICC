...
$sql = 'INSERT INTO proyectos(nombre,year,img_path ,link, descripcion, id_academicos) VALUES (\'%s\', \'%s\', \'%s\', \'%s\', \'%s\' , \'%s\')';
$sql = sprintf($sql, $_POST['nombre'], $_POST['year'], $image,$_POST['link'], $_POST['descripcion'], $_POST['autor']);
