            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="single-widget">
                        <h3>Links</h3>
                        <ul>
                            <li><a href="http://www.alumnos.uda.cl/" target="_blank">Intranet Alumnos</a></li>
                            <li><a href="http://www.docentes.uda.cl/" target="_blank">Intranet Académicos</a></li>
                            <li><a href="http://www.moodle.uda.cl/" target="_blank">Moodle</a></li>
                            <li><a href="https://biblioteca.uda.cl/" target="_blank">Biblioteca</a></li>
                            <li><a href="http://www.fscu.uda.cl/" target="_blank">FSCU</a></li>
                            <li><a href="http://www.fi.uda.cl/" target="_blank">Facultad de Ingeniería</a></li>
                            <li><a href="https://instagram.com/diicc_uda?igshid=ZDdkNTZiNTM=" target="_blank">Instagram</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
