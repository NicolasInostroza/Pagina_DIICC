...
-->
                ...
                <div class="col-md-6">
                    <div class="blog-details">
                        ...
                        <div class="blog-details-content">
                            ...
                            <h3>Descripción de la Carrera:</h3>
                            <br>
                            <p class="quote1" >La carrera de Ingeniería Civil en Computación e Informática tiene como objetivo crear un ingeniero que este orientado a diseñar, desarrollar y gestionar soluciones computacionales integradas, esto incluye: desarrollo de sistemas, elaboración de planes informáticos y adaptación de nuevas tecnologías en su campo de acción. </p>
            ...
            <div class="row blog-details"style="justyfy-content:center;">
            ...
            <div class="row blog-details">
                                <div class="col-md-6 col-sm-12 col-xs-12 blog-details-content">
                                    <h3>Perfil del profesional:</h3>
                                    <br>
                                    <p class="quote">El Ingeniero Civil en Computación e Informática de la Universidad de Atacama se destaca por su formación orientada en el desarrollo de la innovación y la excelencia, para lo cual se le entregan las herramientas necesarias para contribuir al desarrollo de nuestra región y país en forma dinámica y responsable.</p>
                                    <p class="quote">El Ingeniero Civil en Computación e Informática de la Universidad de Atacama es un profesional con alto compromiso con la calidad, y una disposición permanente por mantener vigentes sus conocimientos en tecnologías y gestión. Demuestra capacidad para aplicar el conocimiento innovadoramente en su formación y reconoce el emprendimiento. Aplica los principios de las matemáticas y ciencias del a ingeniería, situaciones propias de un ingeniero civil.</p>
                                    <p class="quote">Está capacitado para gestionar y desarrollar proyectos que involucran sistemas de información y productos de software que cumplan estándares de calidad para satisfacer requerimientos del entorno. Además, de formular y gestionar proyectos informáticos en el ámbito de las TICARs orientadas a soluciones en el área de la informática y ciencias de la Computación.</p>
                                    <p class="quote">El Ingeniero Civil en Computación e Informática de la UDA destaca por el énfasis en la formación de un profesional responsable, proactivo y formado bajo los fundamentos éticos que sustentan la disciplina. La formación entregada, permitirá al egresado: plantear y defender su posición con argumentos sólidos y fundados, siendo un real aporte a los equipos multidisciplinarios que integra. A su vez, este profesional estará capacitado para comunicarse a través del idioma inglés.</p>
                            
                                </div>
                                <div class="col-md-6 blog-details-content">
                                <h3>Campo ocupacional: </h3>
                                <br>
                                <p class="quote">El Ingeniero Civil en Computación e Informática se puede desarrollar profesionalmente en todos los sectores empresariales, tales como: Industria, Comercio, Gobierno, Salud y en donde se requiera de tecnología para la gestión de la administración y automatización de operaciones.</p>
                                <h3>Áreas de desarrollo del profesional:</h3>
                                <p>
                                    <li> Desarrollo de Sistemas de Software.</li>
                                    <li>Gestión TICAR.</li>
